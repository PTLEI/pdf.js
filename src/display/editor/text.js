...
import { TextAnnotationElement } from "../annotation_layer.js";

/**
 * Basic text editor in order to create a Text annotation.
 */
class TextEditor extends AnnotationEditor {
  ...
  constructor(params) {
    ...
    this.#fontSize = params.fontSize || TextEditor._defaultFontSize;
  }
  ...
  static updateDefaultParams(type, value) {
    switch (type) {
      case AnnotationEditorParamsType.FREETEXT_SIZE:
        TextEditor._defaultFontSize = value;
        break;
  ...
  static get defaultPropertiesToUpdate() {
    return [
      [AnnotationEditorParamsType.FREETEXT_SIZE, TextEditor._defaultFontSize],
      [
  ...
  render() {
    ...
    test.style.fontSize = `calc(${this.#fontSize}px * var(--scale-factor))`;
    test.textContent = "这里应该是一个icon";

    this.div.append(test);
  ...
  static deserialize(data, parent, uiManager) {
    ...
    if (data instanceof TextAnnotationElement) {
      const {
        data: {
